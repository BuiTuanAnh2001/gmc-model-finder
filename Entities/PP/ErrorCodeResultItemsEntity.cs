...
namespace gmc_api.Entities
{
    ...
    public class ErrorCodeResultItemsEntity : BaseInfo
    {
        #region Variables
        ...
        #endregion
        public List<PPErrorCodeResultItemImages> lstPPErrorCodeResultItemImages { get; set; } = new List<PPErrorCodeResultItemImages>();
    }
