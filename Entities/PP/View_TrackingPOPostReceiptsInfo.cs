...
{
    #region View_TrackingPOPostReceipts
    //-----------------------------------------------------------
    //Generated By: SQLDBTools.Net ♫ Hồռ؏ ₤ĩռᶋ (v3.0.73)
    //Class: View_TrackingPOPostReceiptsInfo
    //Created Date: Wednesday, 15 Jan 2025
    //-----------------------------------------------------------
    [Table("View_TrackingPOPostReceipts")]
    public class View_TrackingPOPostReceiptsInfo : BaseInfo
    {
        #region Variables
        protected int _view_TrackingPOPostReceiptID;
        ...
        [Key]
        public int View_TrackingPOPostReceiptID
        {
            get { return _view_TrackingPOPostReceiptID; }
            set
            {
                if (value != this._view_TrackingPOPostReceiptID)
                {
                    _view_TrackingPOPostReceiptID = value;
                }
            }
        }
