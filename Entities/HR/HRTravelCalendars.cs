...
namespace gmc_api.Entities
{
    ...
    public class HRTravelCalendars : FixFiveProps
    {
        ...
        public string HRTravelCalendarNo { get; set; } = string.Empty;
        public string HRTravelCalendarName { get; set; } = string.Empty;
        public Nullable<DateTime> HRTravelCalendarDate { get; set; }
        public string HRTravelCalendarDesc { get; set; } = string.Empty;
        ...
        public string HRTravelCalendarWorkPlace { get; set; }=string.Empty;
    }
}
