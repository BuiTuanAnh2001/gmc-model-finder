...
namespace gmc_api.Entities
{
    ...
    public class CustomerProductReqItemsEntity : BaseInfo
    {
        #region Variables
        ...
        public decimal ARCustomerProductReqItemQty
        {
        ...
        public decimal ARCustomerProductReqItemRQty
        {
        ...
        public List<ARCustomerReqItemsInfo> ARCustomerReqItemsList { get; set; } =new List<ARCustomerReqItemsInfo>();
        public List<ARCustomerReqImagesInfo> lstARCustomerReqImages { get; set; }=new List<ARCustomerReqImagesInfo>();
    }
}
