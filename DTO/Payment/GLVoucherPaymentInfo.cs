...
namespace gmc_api.DTO.Payment
{
    public class GLVoucherPaymentInfo : NumberRecord
    {
        ...
        // [JsonPropertyName("pmtMethod")]
        public string GLVoucherPmtMethodTypeCombo { get; set; }
        //  [JsonPropertyName("dueDate")]
        public Nullable<DateTime> GLVoucherDueDate { get; set; }
        public string AACreatedUser { get; set; }
        public string GLVoucherQuestName { get; set; }
        public string GLVoucherPmtReqStatusCombo { get; set; }  
    }
}
