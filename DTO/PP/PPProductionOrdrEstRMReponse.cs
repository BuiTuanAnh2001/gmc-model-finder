...
{
    public class PPProductionOrdrEstRMReponse
    {
        #region Variables
        ...
        protected String _iCProductFGName = String.Empty;
        ...
        public string ICProductFGName
        {
            get { return _iCProductFGName; }
            set
            {
                if (value != this._iCProductFGName)
                {
                    _iCProductFGName = value;
                }
            }
        }
        #endregion
