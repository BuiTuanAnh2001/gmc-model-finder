...
namespace gmc_api.DTO.Shipment
{
    ...
    public class ShipmentItemsEntity:BaseInfo
    {
        #region Variables
        ...
        public List<ICShipmentItemPurchaseReturnItemsInfo> lstICShipmentItemPurchaseReturnItems { get; set; } = new List<ICShipmentItemPurchaseReturnItemsInfo>(); //link trả hàng ncc
        public List<ICShipmentItemROItems> lstICShipmentItemROItems { get; set; } = new List<ICShipmentItemROItems>(); //link đề nghị xuất kho
        public List<ICShipmentItemPurchaseExchangeItemsInfo> lstICShipmentItemPurchaseExchangeItems { get; set; } = new List<ICShipmentItemPurchaseExchangeItemsInfo>(); //link đề nghị đổi hàng
    }
}
